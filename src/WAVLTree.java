...
//				m++;
	...
	public boolean isWAVL(WAVLNode n)
	{
		//getRankDifference == rightChild.rank - leftChild.rank;
		if (n.isExternalLeaf())
			return true;
		boolean d = Math.abs(n.leftChild.rank - n.rightChild.rank) < 2;
		d = d && n.rank - n.leftChild.rank <=2 && n.rank - n.rightChild.rank <=2;
		if(d && !n.leftChild.isExternalLeaf())
			d = d && isWAVL(n.leftChild);
		if(d && !n.rightChild.isExternalLeaf())
			d = d && isWAVL(n.rightChild);
		return d;
	}
...
//		public int inOrderWalkPrint(int i) {		
//			if (this.isExternalLeaf())
//				return i;
//			if (this.isLeaf()){
...
//			else{
//				System.out.println();
//				int j = this.leftChild.inOrderWalkPrint(i);
//				System.out.print("/" + this.key + "\\");
//				System.out.println();
//				return this.rightChild.inOrderWalkPrint(j+1);
//			}
	}
}
